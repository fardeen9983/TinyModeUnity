...
entities.game.Level = entities.game.Level || {};
entities.game.Level.Component = function() {
};
entities.game.Level.Component.prototype = Object.create(null);
entities.game.Level.Component.prototype.constructor = entities.game.Level.Component;
Object.defineProperties(entities.game.Level.Component.prototype, {
});
entities.game.Level.Component._size = 1;
entities.game.Level.Component._fromPtr = function(ptr, v) {
  v = v || Object.create(entities.game.Level.Component.prototype);
  return v;
};
entities.game.Level.Component._toPtr = function(ptr, v) {
};
entities.game.Level.Component._toTempHeapPtr = function(ptr, v) {
};
entities.game.Level.Component._tempHeapPtr = function(v) {
  var ptr = ut.tempHeapPtrBufferZero(1);
  if (v) entities.game.Level.Component._toTempHeapPtr(ptr, v);
  return ptr;
};
entities.game.Level.Component.StorageView = function(ptr) {
  this._ptr = ptr;
};
entities.game.Level.Component.StorageView.prototype = Object.create(null);
entities.game.Level.Component.StorageView.prototype.constructor = entities.game.Level.Component.StorageView;
entities.game.Level.Component._view = entities.game.Level.Component.StorageView;
entities.game.Level.Component.StorageView._isSharedComp = entities.game.Level.Component._isSharedComp = false;
entities.game.Level.Component.StorageView._fromPtr = entities.game.Level.Component._fromPtr;
entities.game.Level.Component.StorageView._toPtr = entities.game.Level.Component._toPtr;
entities.game.Level.Component.StorageView._tempHeapPtr = entities.game.Level.Component._tempHeapPtr;
entities.game.Level.Component.StorageView._size = entities.game.Level.Component._size;
entities.game.Level.Component.StorageView.prototype.$advance = function() {
  this._ptr += 1;
};
Object.defineProperties(entities.game.Level.Component.StorageView.prototype, {
});
entities.game.Level.Component._dtorFn = function dtor(ptr) { /* POD, no-op */ }
// entities.game.Level.Component is a POD type, so a JavaScript side copy constructor entities.game.Level.Component._copyFn = function copy(src, dst) { ... } does not need to be generated for it
Object.defineProperties(entities.game.Level.Component, { cid: { configurable: true, get: function() { delete entities.game.Level.Component.cid; var offsetsPtr = 0, offsetsCount = 0; return entities.game.Level.Component.cid = Module._ut_component_register_cid(/*entities.game.Level.Component*/ 1, 0, 0, offsetsPtr, offsetsCount, 0/*"entities::game::Level::Component"*/, 0, 0); } } });
